...
const Demo = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { data } = await getSummary({ articleText: article.text });
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        >
          ...
          <input
            ...
            required
            className='string_input peer w-full ml-9'
          ></input>
          <button
            type='submit'
            className='submit-btn bg-cyan-500 shadow-lg shadow-cyan-500/50 border-r-amber-50'
          >
            ↩️
          </button>
        </form>
